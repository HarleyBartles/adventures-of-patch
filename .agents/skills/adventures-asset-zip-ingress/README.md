...
Repo-local capability for ingesting asset zips into `HarleyBartles/adventures-of-patch`.

## Purpose

Given an incoming zip of accepted or candidate assets, a repo worker should inspect the package, classify contents against the repo taxonomy, route files to the correct repo locations, rebuild source packages where appropriate, update index mesh files, publish changes, and return evidence.
...
- Canonical local drop zone: `assets/source-zips/incoming/`
