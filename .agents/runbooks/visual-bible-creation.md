...
Start from repo truth. For asset-sensitive work, begin at `assets/INDEX.md` and follow the index mesh to discover existing asset-family docs, bibles, style guides, source zips, receipts, accepted references, and repo-indexed contact-sheet intake packages.
