# Long Course Route Check Booth Asset Sheet v1

Deterministic four-up compile of the approved issue #47 long-course route package onto `template_asset_sheet_4up_equal_header_v1`.

The landed pack preserves:
