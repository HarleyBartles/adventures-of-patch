...
- Asset/source package discovery lives under `assets/source-zips/`. Repo-canonical image inspection lives through repo-indexed contact-sheet dispatch/intake packages built by the Patch contact-sheet exporter.
