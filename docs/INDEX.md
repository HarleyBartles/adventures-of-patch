...
Project documentation, adventure concepts, principles, and workflow notes.

## Files in this directory

No direct documentation files are expected at this level. Navigate into subdirectories.
...
For repo-wide navigation, use root `INDEX.md`, `AGENTS.md`, and `project/index.md` first.
