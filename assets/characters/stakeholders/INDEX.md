...
- **Client / Requester** - brings the need, urgency, context, and initial ask.
- **Product Owner** - defines product outcome, priority, user value, and business trade-offs.
- **Engineering Lead** - grounds the work in technical feasibility, system constraints, architecture, and implementation quality.
- **QA / Verification Lead** - defines proof, acceptance criteria, test evidence, and quality gates.
- **Design / UX Lead** - represents user experience, clarity, usability, accessibility, flows, and interface quality.
- **Operations / Support Lead** - represents operational reality, support load, incidents, monitoring, reliability, and rollout consequences.
- **Risk / Policy Reviewer** - defines guardrails, compliance, privacy, security, policy constraints, and non-goals.
- **Decision Maker / Sponsor** - provides mandate, approval, prioritisation, final call, and organisational accountability.
