...
Reusable visual assets, canonical asset docs, source packages, and receipt packages.
...
- `patch/` - canonical Patch visual references. See `patch/INDEX.md`.
...
Patch references in `patch/` are canonical for Patch image planning and generation.
