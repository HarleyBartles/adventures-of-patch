...
These packages mirror the current project-source visual asset zips when the same filenames are present in ChatGPT project sources. Use the repo index first to identify the current source zip filenames, then look for matching filenames in project sources when visual inspection of zipped PNG assets is needed.
