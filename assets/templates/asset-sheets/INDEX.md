...
Live directory listing for discoverable asset-sheet templates.

## Files in this directory

- `template_asset_sheet_3hero_6alt_v4.png`
...
- `template_asset_sheet_1location_6view_v1.json`
- `template_asset_sheet_world_overview_v1.png`
- `template_asset_sheet_world_overview_v1.json`
- `template_asset_sheet_prop_pack_12grid_v1.png`
- `template_asset_sheet_prop_pack_12grid_v1.json`
- `template_asset_sheet_process_sequence_6panel_v1.png`
- `template_asset_sheet_process_sequence_6panel_v1.json`
...
- `template_asset_sheet_prop_pack_12grid_v1`: equal-weight prop and continuity-object sheet for grouped object packs.
- `template_asset_sheet_process_sequence_6panel_v1`: ordered process or staged-state sheet for sequences such as thin ticket to clarified ticket to executable event card.
